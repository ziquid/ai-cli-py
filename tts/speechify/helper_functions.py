...
def print_usage():
    print("""Usage: speechify_tts.py <options>
...
DEFAULT_TEXT = """
       Welcome to the Speechify text-to-speech demo.
       This is a demonstration of the Speechify text-to-speech API.
       ...
       Thank you for using the Speechify text-to-speech demo.
       """
